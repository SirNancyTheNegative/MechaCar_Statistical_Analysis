...
t.test(x = (suspensioncoil %>% filter(Manufacturing_Lot == "Lot1"))$PSI, mu=1500)
t.test(x = (suspensioncoil %>% filter(Manufacturing_Lot == "Lot2"))$PSI, mu=1500)
t.test(x = (suspensioncoil %>% filter(Manufacturing_Lot == "Lot3"))$PSI, mu=1500)
